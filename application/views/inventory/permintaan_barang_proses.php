...
<div class="row">
    ...
    <div class="col-lg-12 grid-margin">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Proses Barang Keluar</h4>
                <p><small>Data barang keluar automatis terisi berdasarkan tanggal masuk barang yang paling lama, dan yang mendekati tanggal kadaluarsa <span style="color: red;">*</span></small></p>
                <hr>
